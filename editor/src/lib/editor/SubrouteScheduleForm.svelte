<script>
  ...
  $: newConditionPeriodReady = newConditionPeriod != null
...
<div class="border-2 rounded-lg p-2">
  <div class="form-control w-full max-w-xs">
    <label class="input-group">
      ...
      <input
          type="time"
          class="input input-bordered input-sm w-fit" bind:value={newTime} />
    </label>
  </div>
  ...
  <div class="border-2 rounded-lg p-2">
    ...
    <div class="flex gap-12">
      ...
      <label><input class="radio" name="period" type="radio" value="Summer" bind:group={newConditionPeriod}>
        Summer</label>
      <label><input class="radio" name="period" type="radio" value="School" bind:group={newConditionPeriod}>
        School</label>
      <label><input class="radio" name="period" type="radio" value="Holiday" bind:group={newConditionPeriod}>
        Holiday</label>
      <div class="flex flex-col gap-2">
        <label><input class="radio" name="period" type="radio" value="Nth"
                      bind:group={newConditionPeriod}>Occurence#</label>
      ...
      <div class="flex flex-col gap-2">
        <label><input class="radio" name="period" type="radio" value="Range" bind:group={newConditionPeriod}>
          Range</label>
        <div class="form-control">
          <label class="input-group">
    ...
    <div class="flex justify-end">
      <button
          ...
          on:mouseup={addModifier}>Add modifier
      </button>
    </div>
  </div>
